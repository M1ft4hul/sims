        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Update Data Mapel</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php echo base_url('/MapelView') ?>">Mapel</a></li>
                            <li class="breadcrumb-item active">Update Data Mapel</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="/mapel/update/<?= $mapel['id'] ?>" method="POST">
                                <?= csrf_field(); ?>
                                <input type="hidden" class="form-control" name="mapel" value="<?= $mapel['mata_pelajaran'] ?>">
                                <div class="row">
                                    <div class="col-12">
