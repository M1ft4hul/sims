            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto text-right float-right ml-auto">
                        <a href="<?php echo base_url('/formMapel') ?>" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                    </div>
                </div>
            </div>
            <!-- /Page Header -->
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($mapel as $m) : ?>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <div class="actions">
                                                        <a href="/formEdit/Mapel/<?= $m['mata_pelajaran'] ?>" class="btn btn-sm bg-success-light mr-2">
                                                            <i class="fas fa-pen"></i>
                                                        </a>
                                                        <form action="/mapelDelete/<?= $m['id']; ?>" class="d-inline" method="POST">
                                                            <?= csrf_field(); ?>
