            ...
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li class="submenu active">
                        ...
                        <ul>
                            <li><a href="<?php echo base_url('/MapelView') ?>" class="active">Mata Pelajaran</a></li>
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Tambah Data Mapel</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php echo base_url('/MapelView') ?>">Mapel</a></li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="<?php echo base_url('/mapelTambah'); ?>" method="POST">
                                <?= csrf_field(); ?>
                                <div class="row">
                                    <div class="col-12">
                                        <h5 class="form-title"><span>Data Mapel</span></h5>
                                    </div>
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            <label>Mata Pelajaran</label>
                                            <input class="form-control <?php if ($validation->hasError('mata_pelajaran')) : echo ' is-invalid ' ?> <?php endif; ?>" value="<?= old('mata_pelajaran') ?>" name=" mata_pelajaran" type="text" />
                                        </div>
                                        <?php if ($validation->hasError('mata_pelajaran')) {
                                            echo "<div class='alert alert-danger'>" . $validation->getError('mata_pelajaran') . "</div>";
                                        } ?>
                                    </div>
                                    <div class=" col-12">
